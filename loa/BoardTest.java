...
public class BoardTest {
    ...
    public void testLegality1() {
        ...
        assertTrue("f3-f7", b.blocked(sq("c5"), sq("c3")));
        assertFalse(b.isLegal(mv("a2-a7")));
    ...
    public void testMove1() {
        ...
        Board b1 = new Board(BOARD1, BP);
        Board b2 = new Board();
        b2.centerMassFinderBP();
        System.out.println(b2.getAvgDisBP());
        System.out.println(b2.getNumQ3BP());
