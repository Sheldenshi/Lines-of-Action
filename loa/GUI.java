...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Game->Control", this::control);
        addMenuButton("Setting->Manual White", this::manualWP);
        addMenuButton("Setting->Manual Black", this::manualBP);
        addMenuButton("Setting->Auto White", this::autoWP);
        addMenuButton("Setting->Auto Black", this::autoBP);
    ...
    private void manualWP(String dummy) {
        _pendingCommands.offer("manual white");
    }

    /** Response to "manual" button click. */
    private void manualBP(String dummy) {
        _pendingCommands.offer("manual black");
    }

    /** Response to "manual" button click. */
    private void autoWP(String dummy) {
        _pendingCommands.offer("auto white");
    }

    /** Response to "manual" button click. */
    private void autoBP(String dummy) {
    ...
    private void control(String dummy) {
        displayText("Control", "loa/Help.html");
    }
